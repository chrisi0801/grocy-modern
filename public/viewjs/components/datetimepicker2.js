...
Grocy.Components.DateTimePicker2.GetInputElement().on('blur', function()
{
...
Grocy.Components.DateTimePicker2.GetInputElement().on('keyup', function(e)
{
	...
	{
		Grocy.Components.DateTimePicker2.SetValue(moment(GrocyDateInput.ResolveDigits(value)).format(format), inputElement);
		nextInputElement.focus();
	}
